...
public class MemoryInfo implements MemoryInfoMBean {
    ...
    private MemoryPoolMXBean codeCache;
    ...
    public String getPrintInfo() {
        ...
        sb.append(memoryMXBean.getHeapMemoryUsage().getUsed()).append(" ");
        sb.append(memoryMXBean.getNonHeapMemoryUsage().getUsed()).append(" ");
        sb.append(codeCache.getUsage().getUsed());
//        sb.append(getHeapMemoryMax()).append(" ");
//        sb.append(getHeapMemoryUsed()).append(" ");
//        sb.append(getNonHeapMemoryCommitted()).append(" ");
//        sb.append(getNonHeapMemoryInit()).append(" ");
//        sb.append(getNonHeapMemoryMax()).append(" ");
//        sb.append(getNonHeapMemoryUsed()).append(" ");
//        sb.append(getPermGenCommitted()).append(" ");
//        sb.append(getPermGenInit()).append(" ");
//        sb.append(getPermGenMax()).append(" ");
//        sb.append(getPermGenUsed()).append(" ");
        return sb.toString();
    }
